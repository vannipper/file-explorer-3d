...
class EngineInitializer:
    ...
    def start(self):
        ...
        if sys.platform == "win32":
            myappid = 'zenith.engine.alpha.0.1' # arbitrary string
        ...
        # 2. Setup Main Window Dimensions (80% of screen)
